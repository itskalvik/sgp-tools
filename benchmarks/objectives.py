    ...
    if args.sampling_rate == 2 and \
       ...
       not args.distance_budget:
        methods = [
            ...
            'DifferentiableObjective.AOptimal',
            'DifferentiableObjective.BOptimal',
            'DifferentiableObjective.DOptimal',
            'CMA.SLogMI',
            'CMA.SLogMI.cache',
            'CMA.SchurMI',
            'CMA.SchurMI.cache',
            ...
            'CMA.BOptimal',
            'CMA.DOptimal',
            'GreedyObjective.SLogMI',
            'GreedyObjective.SLogMI.cache',
            'GreedyObjective.SchurMI',
            'GreedyObjective.SchurMI.cache',
            'GreedyObjective.AOptimal',
            'GreedyObjective.BOptimal',
            'GreedyObjective.DOptimal',
            'ContinuousSGP',
        ]
