...
class OptimizersBenchmark(IPPBenchmark):
    ...
    def __init__(
        ...
        super().__init__(dataset_path, num_mc, num_robots, max_dist,
                         sampling_rate, xrange, optimizers, distance_budget,
        ...
        for _ in range(self.num_mc):
            for num_waypoints in self.xrange:
                ...
                for optimizer in optimizers:
                    model = get_method('ContinuousSGP')(
                        num_waypoints,
                    ...
                    self.evaluate(solution, num_waypoints, optimizer,
...
if __name__ == '__main__':
    ...
    optimizers = [
        'scipy.CG', 'scipy.L-BFGS-B', 'scipy.BFGS', 'scipy.Newton-CG',
        'tf.SGD', 'tf.Adam', 'tf.RMSprop', 'tf.Nadam'
    ]
    ...
    benchmark = OptimizersBenchmark(args.dataset_path,
                                    ...
                                    args.num_robots,
                                    max_dist,
                                    args.sampling_rate, [args.num_waypoints],
                                    optimizers,
